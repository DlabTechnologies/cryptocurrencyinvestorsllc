...
def send_otp(request):
    ...
    image_path = "static/cryptocurrencyinvestorsllc/images/faviconemail.png"
    image_name = 'faviconemail.png'
...
"""
    ...
    def send_email(subject, message, html_message=None, sender=sender, recipent=recipient_list, ):
...
def dashboard_contact(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = "{0} from cryptocurrencyinvestorsllc has sent you a new message:\n\n{1} \n\n{2} \n\n{3}".format(name, subject, form.cleaned_data.get('message'), phone )
            send_mail('New Enquiry', message, email,['info@cryptocurrencyinvestorsllc.com'])
